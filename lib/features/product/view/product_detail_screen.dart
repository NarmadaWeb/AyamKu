  ...
  Widget _buildHeroImage(BuildContext context, ProductModel product) {
    return Stack(
      children: [
        AspectRatio(
          aspectRatio: 16 / 9,
          // Optimization: Using CachedNetworkImage for the hero image ensures
          // a smooth transition from the catalog/home screen as the image
          // is already cached, eliminating "loading flicker".
